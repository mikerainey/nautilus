...
extern "C" {
  void handle_plus_reduce_array_interrupt(char *buf, void *priv) {
    tpalrts::plus_array_reduce::bench_plus_reduce_array_interrupt();
  }
  void handle_plus_reduce_array_software_polling(char *buf, void *priv) {
    tpalrts::plus_array_reduce::bench_plus_reduce_array_software_polling();
  }
  void handle_plus_reduce_array_manual(char *buf, void *priv) {
    tpalrts::plus_array_reduce::bench_plus_reduce_array_manual();
  }
  void handle_plus_reduce_array_serial(char *buf, void *priv) {
    tpalrts::plus_array_reduce::bench_plus_reduce_array_serial();
  }
}
